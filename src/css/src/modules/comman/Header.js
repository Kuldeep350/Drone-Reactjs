            ...
            <div className="row h-100">
                <div className="col-12 h-100">
                    <nav className="h-100 navbar navbar-expand-lg">
                        <a className="navbar-brand" href="index.html"><img src={require("../../img/core-img/logo.png")} alt=""/></a>
                        ...
                        <div className="collapse navbar-collapse" id="dorneNav">
                            <ul className="navbar-nav mr-auto" id="dorneMenu">
                                ...
                                <li className="nav-item dropdown">
                                    <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Listings <i className="fa fa-angle-down" aria-hidden="true"></i></a>
                            ...
                            <div className="dorne-search-btn">
                                <a id="search-btn" href="#"><i className="fa fa-search" aria-hidden="true"></i> Search</a>
                            </div>
                            {/* <!-- Signin btn --> */}
                            ...
                            <div className="dorne-add-listings-btn">
                                <a href="#" className="btn dorne-btn">+ Add Listings</a>
                            </div>
                        </div>
                    </nav>
                </div>
